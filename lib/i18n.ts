...
const DICT: Record<string, Entry> = {
  ...
  "game.playMode": { ja: "出し方", en: "Play" },
  "game.modeDouble": { ja: "ダブルタップ", en: "Double-tap" },
  "game.modeConfirm": { ja: "選択→確認", en: "Tap + confirm" },
  "game.tapAgain": { ja: "もう一度タップで使う", en: "Tap again to play" },
